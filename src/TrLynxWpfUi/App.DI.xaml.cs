...
namespace TrLynxWpfUi
{
    public partial class App
    {
        ...
        private TrLynxLib.Abstraction.Color GetColorStructFromWpfColor(System.Windows.Media.Color wpfColor)
            => new TrLynxLib.Abstraction.Color(wpfColor.R, wpfColor.G, wpfColor.B, wpfColor.A);
