...
namespace TrLynxLib.ViewModel.Views
{
    public class AboutViewModel : ViewModelBase
    {
        ...
        public string Title
            => $"TrLynx - {System.Reflection.Assembly.GetExecutingAssembly().GetName().Version?.ToString(3) ?? "Unknown Version"}";
        ...
        public string AboutText
            => "TrLynx is a Texture Sets Building Tool which is intended to facilitate the process of " +
            ...
            "\r\n" +
            "\r\n" +
            "TrLynx is an independent software, not supported by Crystal Dynamics or the Embracer Group.";
    }
}
