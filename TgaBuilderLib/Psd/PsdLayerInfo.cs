...
namespace TgaBuilderLib.Psd
{
    ...
    public class PsdLayerInfo
    {
        ...
        /// </param>
        /// <param name="rect">Position and size of the layer within the document canvas.</param>
        /// <param name="name">Display name of the layer.</param>
        /// <param name="opacity">0 = transparent, 255 = opaque.</param>
        /// <param name="visible">Whether the layer is visible.</param>
        /// <param name="blendModeKey">
        /// Four-character PSD blend mode key (e.g. "norm" for Normal,
        /// "mul " for Multiply). Default is "norm".
        /// </param>
        public PsdLayerInfo(
